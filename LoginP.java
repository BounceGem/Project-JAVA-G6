...
public class LoginP extends javax.swing.JFrame {
  ...
  @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        NameL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/facilityT.png"))); // NOI18N
        NameL.setToolTipText("");
        getContentPane().add(NameL, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 200, 800, 90));
