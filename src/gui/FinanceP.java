 ...
 * @author parncha
 */
public class FinanceP extends javax.swing.JFrame {

    /**
     * Creates new form FinanceP
     */
    public FinanceP() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 170, 300, -1));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pic/finanT.png"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 800, 100));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinanceP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
